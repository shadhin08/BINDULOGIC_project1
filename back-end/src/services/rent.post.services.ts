...
const saveRentPost=async(data:IRentPostInterface, user: string)=>
{
    try 
    {
        ...
        const {heading, description, rent, bed, bath, size, rentAreaName, image}=data;
...
const RentPostServices={ saveRentPost, findRentPostsByUsername, getAllrentPost, deleteRentPostById };
